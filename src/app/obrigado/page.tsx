...
export const metadata = {
  ...
  description: 'Confirmação do pedido na Conexão Perfumaria.',
};
...
function getStatusCopy(status: string | undefined): {
  ...
  if (status === 'pago') {
    return {
      title: 'Obrigado pela compra',
      description:
        'Pagamento aprovado. A equipe vai separar seu pedido e seguir com o atendimento.',
    };
  }
  ...
  if (status === 'pendente') {
    return {
      ...
      description:
        'Seu pedido foi criado e a confirmação do pagamento pode levar alguns instantes.',
    };
  }
  ...
  return {
    title: 'Pedido recebido',
    description:
      'Registramos seu pedido. Se precisar, fale com a equipe pelo WhatsApp para confirmar os próximos passos.',
  };
}
